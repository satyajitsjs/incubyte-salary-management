# Generated by Django 5.2.17 on 2026-08-18 14:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['department', 'country'], name='employees_e_departm_70cefa_idx'), models.Index(fields=['country', 'annual_salary_usd'], name='employees_e_country_e9db6f_idx'), models.Index(fields=['department', 'annual_salary_usd'], name='employees_e_departm_b12463_idx')],
            },
        ),
        migrations.CreateModel(
            name='SalaryChange',
